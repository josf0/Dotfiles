...
keys.globalkeys = gears.table.join(
	...
	--- Emoji picker
	awful.key({ mod }, "f", apps.emoji_picker, { description = "emoji picker", group = "app" }),
	--- Clipboard
	...
	-- Apps
	-- Spawn browser
	awful.key({ mod }, "b", apps.browser, { description = "web browser", group = "launcher" }),
	-- Spawn gui file manager
	awful.key({ mod }, "e", apps.file_manager, { description = "file manager", group = "launcher" }),
	-- Terminal file manager
	-- awful.key({ mod }, "F4", apps.term_filemanager, { description = "term filemanager", group = "launcher" }),
	-- Primary editor
	-- awful.key({ mod }, "f", apps.editor, { description = "editor", group = "launcher" }),
	-- Gui editor
	-- awful.key({ mod }, "F6", apps.visual_editor, { description = "visual editor", group = "launcher" }),
	-- Add more
	awful.key({ mod }, "s", user.spotify, { description = "file ", group = "launcher" }),
	...
	-- Process monitor
	awful.key({ ctrl, shift }, "Escape", apps.process_monitor, { description = "process monitor", group = "launcher" })
)
